...
function evaluateComplianceRisks(text) {
  ...
  // 1. REGLAS PERSONALIZADAS DINÁMICAS (CONFIGURADOR)
  ...
  const piiKeywords = /\b(dni|nie|nif|cif|pasaporte|nómina|nomina|sueldo|salario|retención|finiquito|historial clínico|diagnóstico|tarjeta|cvv|credit card|cuenta bancaria|contraseña|password)\b/i;
