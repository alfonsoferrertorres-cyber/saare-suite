...
export default function App() {
  ...
  // FUNCIÓN DE VERIFICACIÓN CRIPTOGRÁFICA NATIVA DEL NAVEGADOR
  ...
  return (
    <div style={{ backgroundColor: '#e2e8f0', minHeight: '100vh', color: '#1e293b', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ padding: '28px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        {/* PESTAÑA 2: RUNLIVE CON BOTÓN DE AUDITORÍA CRIPTOGRÁFICA EN NAVEGADOR / GOOGLE */}
        {activeTab === 'RUNLIVE' && (
          <div>
            <div style={{ background: '#ffffff', border: '1px solid #cbd5e1', borderRadius: '12px', padding: '24px', marginBottom: '24px', boxShadow: '0 4px 12px rgba(0,0,0,0.04)' }}>
              ...
              {/* MUESTRA DE VERIFICACIÓN EN VIVO */}
              {verificationResult && (
                <div style={{ background: '#f0fdf4', border: '1px solid #16a34a', padding: '14px 20px', borderRadius: '8px', marginBottom: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    <span style={{ fontSize: '11px', color: '#15803d', fontWeight: 'bold', display: 'block' }}>✓ AUDITORÍA EN NAVEGADOR CONSTATADA</span>
                  ...
                  <span style={{ background: '#16a34a', color: '#fff', padding: '4px 10px', borderRadius: '4px', fontSize: '10px', fontWeight: 'bold' }}>SELLO INDEPENDIENTE COINCIDENTE</span>
                </div>
              )}
            ...
            {/* SECCIÓN EVIDENCIA GLOBAL E INTANGIBLE */}
            <div style={{ background: '#ffffff', border: '1px solid #cbd5e1', borderRadius: '12px', padding: '24px', boxShadow: '0 4px 12px rgba(0,0,0,0.04)' }}>
              ...
              <div style={{ background: '#f8fafc', borderLeft: '4px solid #0284c7', padding: '16px 20px', borderRadius: '6px', marginBottom: '20px' }}>
                <p style={{ color: '#1e293b', fontSize: '14px', lineHeight: '1.7', margin: 0 }}>
                  <strong>¿Cómo realizar la verificación independiente en cualquier navegador?</strong><br/>
                  Cualquier auditor o tribunal puede presionar el botón de verificación para ejecutar la API estándar <code>crypto.subtle.digest</code> de W3C presente en <strong>Google Chrome, Edge, Safari o Firefox</strong>. Esto calcula de forma autónoma el hash de la evidencia sin consultar bases de datos centralizadas, certificando que el objeto intangible no ha sido alterado.
                </p>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
                ...
                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '16px', borderRadius: '10px' }}>
                  ...
                  <div style={{ fontSize: '11px', color: '#475569', lineHeight: '1.5' }}>
                    Vinculación unívoca e inalterable entre el operador humano y el hecho tecnológico registrado.
                  </div>
                </div>

                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '16px', borderRadius: '10px' }}>
                  <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#16a34a', marginBottom: '6px' }}>🌐 VERIFICACIÓN EN NAVEGADOR</div>
                  <div style={{ fontSize: '11px', color: '#475569', lineHeight: '1.5' }}>
                    Auditoría inmediata ejecutando motores WebCrypto universales (Google/Edge/Firefox) sin intermediarios.
                  </div>
                </div>
                ...
                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '16px', borderRadius: '10px' }}>
                  ...
                  <div style={{ fontSize: '11px', color: '#475569', lineHeight: '1.5' }}>
                    Sin intervención humana ni envío de tokens o datos confidenciales a infraestructura de terceros.
                  </div>
                </div>
                ...
                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '16px', borderRadius: '10px' }}>
                  ...
                  <div style={{ fontSize: '11px', color: '#475569', lineHeight: '1.5' }}>
                    Estructura probatoria estándar universal que permite a cualquier IA (ChatGPT, Claude, Gemini, Llama) validar la prueba.
                  </div>
                </div>
...
console.log('=== BOTÓN DE AUDITORÍA CRIPTOGRÁFICA EN NAVEGADOR INTEGRADO CON ÉXITO ===');
