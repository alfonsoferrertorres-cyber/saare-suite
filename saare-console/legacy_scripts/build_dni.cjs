  ...
  return (
    <div style={{ backgroundColor: '#e2e8f0', minHeight: '100vh', color: '#1e293b', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ padding: '28px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        {/* PESTAÑA 2: RUNLIVE CON EL CONCEPTO DEL DNI DIGITAL DEL OPERADOR HUMANO */}
        {activeTab === 'RUNLIVE' && (
          <div>
            ...
            {/* SECCIÓN EVIDENCIA GLOBAL E INTANGIBLE INTEGRANDO EL DNI PROBATORIO DEL HUMANO */}
            <div style={{ background: '#ffffff', border: '1px solid #cbd5e1', borderRadius: '12px', padding: '24px', boxShadow: '0 4px 12px rgba(0,0,0,0.04)' }}>
              <div style={{ borderBottom: '1px solid #e2e8f0', paddingBottom: '12px', marginBottom: '16px' }}>
                ...
                <p style={{ color: '#64748b', fontSize: '13px', margin: '4px 0 0 0' }}>Fijación del "DNI Digital Operativo" del operador humano que interactúa con la tecnología.</p>
              </div>

              <p style={{ color: '#334155', fontSize: '14px', lineHeight: '1.7', margin: '0 0 20px 0' }}>
                De esta forma se genera un **"DNI probatorio" de la interacción humana** con la tecnología. La evidencia <strong style={{ color: '#0284c7' }}>{lastLog?.id || 'EV-864387'}</strong> actúa como una cédula de identidad inalterable sobre la conducta del usuario, fijando en memoria RAM L7 su responsabilidad operativa sin manipulación posible.
              </p>

              {/* 4 PILARES INTEGRADOS INCLUYENDO EL DNI DEL HUMANO Y MEMORIA RAM */}
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
                
                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '16px', borderRadius: '10px' }}>
                  <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#0284c7', marginBottom: '6px' }}>🪪 DNI DEL OPERADOR HUMANO</div>
                  <div style={{ fontSize: '11px', color: '#475569', lineHeight: '1.5' }}>
                    Identidad probatoria e inconfundible de la conducta del usuario que utiliza la tecnología en ese instante preciso.
                  </div>
                </div>

                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '16px', borderRadius: '10px' }}>
                  <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#16a34a', marginBottom: '6px' }}>⚡ PROCESAMIENTO EN RAM</div>
                  <div style={{ fontSize: '11px', color: '#475569', lineHeight: '1.5' }}>
                    Sello generado en memoria RAM volátil en tiempo real. Cero escritura en disco en bruto y cero alterabilidad física.
                  </div>
                </div>
                ...
                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '16px', borderRadius: '10px' }}>
                  ...
                  <div style={{ fontSize: '11px', color: '#475569', lineHeight: '1.5' }}>
                    Capa de protección nativa in-situ. Ningún dato ni token sale hacia servidores o modelos de terceros.
                  </div>
                </div>

                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '16px', borderRadius: '10px' }}>
                  <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#dc2626', marginBottom: '6px' }}>🧠 VERIFICACIÓN MULTI-IA</div>
                  <div style={{ fontSize: '11px', color: '#475569', lineHeight: '1.5' }}>
                    Estructura probatoria universal interpretable y auditable unánimemente por cualquier IA (ChatGPT, Claude, Gemini, Llama).
                  </div>
                </div>
...
console.log('=== DNI DIGITAL DEL HUMANO INTEGRADO EN SAARE-CONSOLE ===');
