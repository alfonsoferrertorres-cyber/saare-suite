  ...
  return (
    <div style={{ backgroundColor: '#e2e8f0', minHeight: '100vh', color: '#1e293b', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ padding: '28px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        {/* PESTAÑA 2: RUNLIVE CON AUDITORÍA CRIPTOGRÁFICA Y EXPLICACIÓN DE INALTERABILIDAD */}
        {activeTab === 'RUNLIVE' && (
          <div>
            ...
            {/* SECCIÓN DEMOSTRACIÓN DE POR QUÉ SE SABE QUE NO HA SIDO MODIFICADA */}
            <div style={{ background: '#ffffff', border: '1px solid #cbd5e1', borderRadius: '12px', padding: '24px', boxShadow: '0 4px 12px rgba(0,0,0,0.04)' }}>
              <div style={{ borderBottom: '1px solid #e2e8f0', paddingBottom: '12px', marginBottom: '16px' }}>
                ...
                <p style={{ color: '#64748b', fontSize: '13px', margin: '4px 0 0 0' }}>¿Cómo se prueba matemáticamente que la evidencia no ha sufrido la menor alteración?</p>
              </div>
              ...
              <div style={{ background: '#f8fafc', borderLeft: '4px solid #16a34a', padding: '16px 20px', borderRadius: '6px', marginBottom: '20px' }}>
                <p style={{ color: '#1e293b', fontSize: '14px', lineHeight: '1.7', margin: 0 }}>
                  ...
                  La integridad del registro se apoya en funciones digestivas asimétricas (<span style={{ color: '#0284c7', fontFamily: 'monospace' }}>SHA-256 + ED25519</span>). Si alguien intentara cambiar un solo carácter, un espacio o un signo de puntuación en el hecho registrado, la huella matemática calculada por el navegador **cambiaría de forma drástica e irreconocible**. Al recalcular el hash localmente en la web de forma nativa mediante el motor WebCrypto (Google Chrome, Edge, Safari, Firefox), se demuestra que la firma coincide exactamente bit por bit con el momento de captura en memoria RAM.
                </p>
              </div>

              {/* 4 PILARES TÉCNICO-LEGALES DE LA INALTERABILIDAD */}
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
                
                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '16px', borderRadius: '10px' }}>
                  <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#0284c7', marginBottom: '6px' }}>📉 EFECTO AVALANCHA</div>
                  <div style={{ fontSize: '11px', color: '#475569', lineHeight: '1.5' }}>
                    Modificar un único bit de la evidencia altera más del 50% de la firma criptográfica resultante, invalidando el registro de inmediato.
                  </div>
                </div>

                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '16px', borderRadius: '10px' }}>
                  <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#16a34a', marginBottom: '6px' }}>⏱️ TIMESTAMP INMUTABLE EN RAM</div>
                  <div style={{ fontSize: '11px', color: '#475569', lineHeight: '1.5' }}>
                    La hora exacta y el contenido se sellan en la memoria volátil L7 antes de cualquier almacenamiento, impidiendo la manipulación posterior.
                  </div>
                </div>

                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '16px', borderRadius: '10px' }}>
                  <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#b45309', marginBottom: '6px' }}>🔒 CERO TOKENS EXTERNOS</div>
                  <div style={{ fontSize: '11px', color: '#475569', lineHeight: '1.5' }}>
                    Proceso 100% nativo in-situ. Ningún dato ni token sale a servidores cloud ni requiere intervención manual humana.
                  </div>
                </div>

                <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', padding: '16px', borderRadius: '10px' }}>
                  <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#dc2626', marginBottom: '6px' }}>🧠 VERIFICACIÓN PERICIAL MULTI-IA</div>
                  <div style={{ fontSize: '11px', color: '#475569', lineHeight: '1.5' }}>
                    Cualquier modelo de IA independiente (ChatGPT, Claude, Gemini, Llama) puede comprobar de forma unánime que el hash no ha sido alterado.
                  </div>
                </div>
...
console.log('=== APP.JSX ACTUALIZADO Y COMPILADO EXITOSAMENTE ===');
