      ...
      <div className="relative rounded-3xl border border-slate-800 bg-[#050811] overflow-hidden min-h-[460px] flex items-end p-6 sm:p-12 shadow-2xl">
        ...
        <div className="relative z-10 max-w-2xl bg-slate-950/90 border border-slate-800 p-6 sm:p-8 rounded-2xl backdrop-blur-md space-y-4 shadow-2xl">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            <a href="#calculadora" className="px-5 py-2.5 rounded-xl bg-red-600 hover:bg-red-500 text-white font-black font-mono text-xs uppercase tracking-wider transition-all shadow-lg hover:scale-105 flex items-center gap-1.5"><span>PROBAR SANDBOX L7 (7 DÍAS GRATIS) (7 DÍAS GRATIS)</span><span className="text-amber-300">⚡</span></a>
          </div>
        </div>
      </div>
    </section>
