...
var init_completions = __esm({
  "v1/chat/completions.js"() {
    init_functionsRoutes_0_10284754669331897();
    __name(onRequestPost, "onRequestPost");
  }
});

// api/engineer/config.js
...
async function onRequest2(context) {
  ...
  try {
    ...
    const res = await fetch("https://api.resend.com/emails", { method: "POST", headers: { "Authorization": `Bearer ${context.env.RESEND_API_KEY}`, "Content-Type": "application/json" }, body: JSON.stringify({ from: "SAARE Platform <onboarding@saare.es>", to: ["alfonsosb1@gmail.com"], subject: `[Discovery Request] ${body.name || body.company || "Nuevo Lead"}`, html: `<p><strong>Nombre:</strong> ${body.name || body.fullName}</p><p><strong>Email de contacto:</strong> ${body.email || body.corporateEmail}</p><p><strong>Empresa:</strong> ${body.company}</p>` }) });
    const resData = await res.json();
    if (!res.ok) {
      return new Response(JSON.stringify({ error: resData }), { status: res.status, headers: { ...corsHeaders, "Content-Type": "application/json" } });
    }
    return new Response(JSON.stringify({ success: true, resendResponse: resData }), { status: 200, headers: { ...corsHeaders, "Content-Type": "application/json" } });
  } catch (err) {
...
var require_stringify = __commonJS({
  "../node_modules/qs/lib/stringify.js"(exports, module) {
    ...
    var sentinel = {};
    var stringify2 = /* @__PURE__ */ __name(function stringify3(object, prefix, generateArrayPrefix, commaRoundTrip, allowEmptyArrays, strictNullHandling, skipNulls, encodeDotInKeys, encoder, filter2, sort, allowDots, serializeDate, format, formatter, encodeValuesOnly, charset, sideChannel) {
      var obj = object;
...
var require_parse = __commonJS({
  "../node_modules/qs/lib/parse.js"(exports, module) {
    ...
    var parseObject = /* @__PURE__ */ __name(function(chain2, val, options, valuesParsed) {
...
function validateInteger(name2, n2, defaultVal) {
...
function createStripe(platformFunctions, requestSender = defaultRequestSenderFactory) {
  ...
  Stripe2.prototype = {
     ...
     * It may be deprecated and removed in the future.
     */
    getConstant: /* @__PURE__ */ __name((c2) => {
      switch (c2) {
        case "DEFAULT_HOST":
          return DEFAULT_HOST;
        case "DEFAULT_PORT":
...
async function onRequestPost2(context) {
  ...
  try {
    ...
    const stripe = new stripe_esm_worker_default(apiKey, {
      apiVersion: "2023-10-16",
      httpClient: stripe_esm_worker_default.createSubresourceHTTPClient()
      // Optimización nativa para Cloudflare Workers
    });
    let body = {};
    try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode,
      customer_email: email.trim() !== "" ? email.trim() : void 0,
      line_items: [
        {
          price: priceId,
          quantity: 1
      ...
      custom_fields: [
        {
          key: "empresa",
          label: { type: "custom", custom: "Nombre de la Empresa / Organizaci\xF3n" },
          type: "text",
          optional: false
        }
      ],
...
var require_react_production_min = __commonJS({
  "../node_modules/react/cjs/react.production.min.js"(exports) {
    ...
    var P = /\/+/g;
    function Q(a, b) {
      return "object" === typeof a && null !== a && null != a.key ? escape4("" + a.key) : b.toString(36);
    }
    __name(Q, "Q");
    function R(a, b, e2, d, c2) {
      ...
      if (h) return h = a, c2 = c2(h), a = "" === d ? "." + Q(h, 0) : d, I2(c2) ? (e2 = "", null != a && (e2 = a.replace(P, "$&/") + "/"), R(c2, b, e2, "", function(a2) {
        return a2;
      ...
      else if (f = A(a), "function" === typeof f) for (a = f.call(a), g = 0; !(k = a.next()).done; ) k = k.value, f = d + Q(k, g++), h += R(k, b, e2, f, c2);
    ...
    __name(X, "X");
    exports.Children = { map: S, forEach: /* @__PURE__ */ __name(function(a, b, e2) {
      S(a, function() {
    ...
    exports.cloneElement = function(a, b, e2) {
      ...
      return { $$typeof: l2, type: a.type, key: c2, ref: k, props: d, _owner: h };
    };
...
var require_react_dom_server_legacy_browser_production_min = __commonJS({
  "../node_modules/react-dom/cjs/react-dom-server-legacy.browser.production.min.js"(exports) {
    ...
    "children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(a) {
      t2[a] = new r2(a, 0, false, a, null, false, false);
    });
    [["acceptCharset", "accept-charset"], ["className", "class"], ["htmlFor", "for"], ["httpEquiv", "http-equiv"]].forEach(function(a) {
      var b = a[0];
      t2[b] = new r2(b, 1, false, a[1], null, false, false);
    });
    ["contentEditable", "draggable", "spellCheck", "value"].forEach(function(a) {
      t2[a] = new r2(a, 2, false, a.toLowerCase(), null, false, false);
    });
    ["autoReverse", "externalResourcesRequired", "focusable", "preserveAlpha"].forEach(function(a) {
      t2[a] = new r2(a, 2, false, a, null, false, false);
    });
    "allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(a) {
      t2[a] = new r2(a, 3, false, a.toLowerCase(), null, false, false);
    });
    ["checked", "multiple", "muted", "selected"].forEach(function(a) {
      t2[a] = new r2(a, 3, true, a, null, false, false);
    });
    ["capture", "download"].forEach(function(a) {
      t2[a] = new r2(a, 4, false, a, null, false, false);
    });
    ["cols", "rows", "size", "span"].forEach(function(a) {
      t2[a] = new r2(a, 6, false, a, null, false, false);
    });
    ["rowSpan", "start"].forEach(function(a) {
      t2[a] = new r2(a, 5, false, a.toLowerCase(), null, false, false);
    });
    var ka = /[\-:]([a-z])/g;
    function la(a) {
    ...
    "accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(a) {
      ...
      t2[b] = new r2(b, 1, false, a, null, false, false);
    });
    "xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(a) {
      var b = a.replace(ka, la);
      t2[b] = new r2(b, 1, false, a, "http://www.w3.org/1999/xlink", false, false);
    });
    ["xml:base", "xml:lang", "xml:space"].forEach(function(a) {
      var b = a.replace(ka, la);
      t2[b] = new r2(b, 1, false, a, "http://www.w3.org/XML/1998/namespace", false, false);
    });
    ["tabIndex", "crossOrigin"].forEach(function(a) {
      t2[a] = new r2(a, 1, false, a.toLowerCase(), null, false, false);
    });
    t2.xlinkHref = new r2("xlinkHref", 1, false, "xlink:href", "http://www.w3.org/1999/xlink", true, false);
    ["src", "href", "action", "formAction"].forEach(function(a) {
      t2[a] = new r2(a, 1, false, a.toLowerCase(), null, true, true);
    });
    var u = {
    ...
    function ta(a, b, c2) {
      ...
      for (var d in c2) if (p.call(c2, d)) {
        ...
        if (null != f && "boolean" !== typeof f && "" !== f) {
          ...
          b ? (b = false, a.push(' style="', e2, ":", f)) : a.push(";", e2, ":", f);
        }
      }
      b || a.push('"');
    }
    ...
    function x(a, b, c2, d) {
      ...
      if (!(2 < c2.length) || "o" !== c2[0] && "O" !== c2[0] || "n" !== c2[1] && "N" !== c2[1]) {
        if (b = t2.hasOwnProperty(c2) ? t2[c2] : null, null !== b) {
          switch (typeof d) {
            case "function":
            case "symbol":
              return;
          ...
          switch (b.type) {
            case 3:
              ...
              break;
            case 4:
              true === d ? a.push(" ", c2, '=""') : false !== d && a.push(" ", c2, '="', v(d), '"');
              break;
            case 5:
              isNaN(d) || a.push(" ", c2, '="', v(d), '"');
              break;
            case 6:
              !isNaN(d) && 1 <= d && a.push(" ", c2, '="', v(d), '"');
              break;
            default:
              b.sanitizeURL && (d = "" + d), a.push(" ", c2, '="', v(d), '"');
          }
        } else if (ja(c2)) {
          switch (typeof d) {
            case "function":
    ...
    function va(a, b, c2, d) {
      ...
      a.push(">");
      y(a, f, c2);
      return "string" === typeof c2 ? (a.push(v(c2)), null) : c2;
    }
    __name(va, "va");
    ...
    __name(A, "A");
    function ya(a, b, c2, d, f) {
      switch (b) {
        case "select":
          a.push(A("select"));
          var e2 = null, g = null;
          for (n2 in c2) if (p.call(c2, n2)) {
            var h = c2[n2];
            if (null != h) switch (n2) {
              case "children":
                e2 = h;
        ...
        case "option":
          ...
          if (null != g) if (c2 = null !== k ? "" + k : ua(h), qa(g)) for (d = 0; d < g.length; d++) {
            if ("" + g[d] === c2) {
              a.push(' selected=""');
              break;
            }
        ...
        case "input":
          a.push(A("input"));
          k = n2 = h = e2 = null;
          for (g in c2) if (p.call(c2, g) && (m = c2[g], null != m)) switch (g) {
            case "children":
            case "dangerouslySetInnerHTML":
          ...
          null !== n2 ? x(a, d, "checked", n2) : null !== k && x(a, d, "checked", k);
          null !== e2 ? x(a, d, "value", e2) : null !== h && x(a, d, "value", h);
          a.push("/>");
          return null;
        case "menuitem":
          a.push(A("menuitem"));
          for (var C in c2) if (p.call(c2, C) && (e2 = c2[C], null != e2)) switch (C) {
            case "children":
            case "dangerouslySetInnerHTML":
              throw Error(l2(400));
            default:
        ...
        case "title":
          a.push(A("title"));
          e2 = null;
          for (q in c2) if (p.call(c2, q) && (g = c2[q], null != g)) switch (q) {
            case "children":
              e2 = g;
              break;
            case "dangerouslySetInnerHTML":
        ...
        case "wbr":
          a.push(A(b));
          for (var D in c2) if (p.call(c2, D) && (e2 = c2[D], null != e2)) switch (D) {
            case "children":
            case "dangerouslySetInnerHTML":
        ...
        case "html":
          return 0 === f.insertionMode && a.push("<!DOCTYPE html>"), va(a, c2, b, d);
        default:
          if (-1 === b.indexOf("-") && "string" !== typeof c2.is) return va(a, c2, b, d);
          a.push(A(b));
          g = e2 = null;
    ...
    __name(Ea, "Ea");
    function Fa(a, b, c2, d) {
      if (c2.generateStaticMarkup) return a.push(v(b)), false;
    ...
    function cb(a, b) {
      ...
      a.depth === c2.depth ? F(a, c2) : cb(a, c2);
      b.context._currentValue2 = b.value;
    }
    __name(cb, "cb");
    function G(a) {
      var b = E;
      b !== a && (null === b ? ab2(a) : null === a ? $a(b) : b.depth === a.depth ? F(b, a) : b.depth > a.depth ? bb(b, a) : cb(b, a), E = a);
    }
    __name(G, "G");
    ...
    function eb(a, b, c2, d) {
      ...
      "function" === typeof g && (g = g(c2, f), f = null === g || void 0 === g ? f : B({}, f, g), a.state = f);
      if ("function" !== typeof b.getDerivedStateFromProps && "function" !== typeof a.getSnapshotBeforeUpdate && ("function" === typeof a.UNSAFE_componentWillMount || "function" === typeof a.componentWillMount)) if (b = a.state, "function" === typeof a.componentWillMount && a.componentWillMount(), "function" === typeof a.UNSAFE_componentWillMount && a.UNSAFE_componentWillMount(), b !== a.state && db.enqueueReplaceState(a, a.state, null), null !== e2.queue && 0 < e2.queue.length) if (b = e2.queue, g = e2.replace, e2.queue = null, e2.replace = false, g && 1 === b.length) a.state = b[0];
      else {
        e2 = g ? b[0] : a.state;
        f = true;
        for (g = g ? 1 : 0; g < b.length; g++) {
          var h = b[g];
          h = "function" === typeof h ? h.call(a, e2, c2, d) : h;
    ...
    function gb(a, b, c2) {
      ...
      if (30 < e2) {
        ...
        d >>= g;
        f -= g;
        return { id: 1 << 32 - H(b) + f | c2 << f | d, overflow: e2 + a };
      }
    ...
    function tb(a, b, c2) {
      ...
      if (L) {
        var d = K.queue;
        b = d.dispatch;
        if (null !== O && (c2 = O.get(d), void 0 !== c2)) {
          O.delete(d);
          d = K.memoizedState;
          do
      ...
      a = a === sb ? "function" === typeof b ? b() : b : void 0 !== c2 ? c2(b) : b;
      K.memoizedState = a;
    ...
    function ub(a, b, c2) {
      ...
      if (a === I2) if (M = true, a = { action: c2, next: null }, null === O && (O = /* @__PURE__ */ new Map()), c2 = O.get(b), void 0 === c2) O.set(b, a);
      else {
    ...
    __name(T, "T");
    function Ab(a, b, c2, d, f, e2, g, h, k) {
      var m = [], n2 = /* @__PURE__ */ new Set();
      b = { destination: null, responseState: b, progressiveChunkSize: void 0 === d ? 12800 : d, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: n2, pingedTasks: m, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: void 0 === f ? zb : f, onAllReady: void 0 === e2 ? T : e2, onShellReady: void 0 === g ? T : g, onShellError: void 0 === h ? T : h, onFatalError: void 0 === k ? T : k };
      c2 = U(b, 0, null, c2, false, false);
      c2.parentFlushed = true;
      a = Bb(b, a, null, c2, n2, Ya, null, fb);
      m.push(a);
      return b;
    }
    __name(Ab, "Ab");
    function Bb(a, b, c2, d, f, e2, g, h) {
      a.allPendingTasks++;
      ...
      var k = { node: b, ping: /* @__PURE__ */ __name(function() {
        ...
        b2.push(k);
        1 === b2.length && Cb(a);
      }, "ping"), blockedBoundary: c2, blockedSegment: d, abortSet: f, legacyContext: e2, context: g, treeContext: h };
      f.add(k);
      return k;
    }
    __name(Bb, "Bb");
    function U(a, b, c2, d, f, e2) {
      return { status: 0, id: -1, index: b, parentFlushed: false, chunks: [], children: [], formatContext: d, boundary: c2, lastPushedText: f, textEmbedded: e2 };
    }
    __name(U, "U");
    function V2(a, b) {
      a = a.onError(b);
    ...
    __name(W, "W");
    function Db(a, b, c2, d, f) {
      I2 = {};
      ob = b;
      N = 0;
      for (a = c2(d, f); M; ) M = false, N = 0, P += 1, K = null, a = c2(d, f);
      rb();
      return a;
    }
    __name(Db, "Db");
    function Eb(a, b, c2, d) {
      ...
      if (null !== e2 && void 0 !== e2) {
        ...
        if ("function" !== typeof c2.getChildContext) d = g;
          ...
          for (var h in c2) if (!(h in e2)) throw Error(l2(108, Xa(d) || "Unknown", h));
          d = B({}, g, c2);
        }
        b.legacyContext = d;
        X(a, b, f);
    ...
    __name(Fb, "Fb");
    function Gb(a, b, c2, d, f) {
      if ("function" === typeof c2) if (c2.prototype && c2.prototype.isReactComponent) {
        f = Za(c2, b.legacyContext);
        var e2 = c2.contextType;
        e2 = new c2(d, "object" === typeof e2 && null !== e2 ? e2._currentValue2 : f);
        eb(e2, c2, d, f);
        Eb(a, b, e2, c2);
      } else {
        e2 = Za(c2, b.legacyContext);
        f = Db(a, b, c2, d, e2);
        var g = 0 !== N;
        if ("object" === typeof f && null !== f && "function" === typeof f.render && void 0 === f.$$typeof) eb(f, c2, d, e2), Eb(a, b, f, c2);
        else if (g) {
          d = b.treeContext;
        ...
        f = b.blockedSegment;
        e2 = ya(f.chunks, c2, d, a.responseState, f.formatContext);
        f.lastPushedText = false;
        g = f.formatContext;
        f.formatContext = ra(g, c2, d);
        Hb(a, b, e2);
        f.formatContext = g;
        switch (c2) {
          case "area":
          ...
          case Oa:
            a: {
              ...
              try {
                ...
                m.status = 4, h.forceClientRender = true, h.errorDigest = V2(a, n2);
              } finally {
                b.blockedBoundary = c2, b.blockedSegment = f;
              }
              b = Bb(a, e2, c2, k, g, b.legacyContext, b.context, b.treeContext);
        ...
        if ("object" === typeof c2 && null !== c2) switch (c2.$$typeof) {
          case Na:
            d = Db(a, b, c2.render, d, f);
            if (0 !== N) {
              c2 = b.treeContext;
              b.treeContext = gb(c2, 1, 0);
              try {
                X(a, b, d);
              } finally {
                b.treeContext = c2;
          ...
          case La:
            ...
            c2._currentValue2 = d;
            g = E;
            E = d = { parent: g, depth: null === g ? 0 : g.depth + 1, context: c2, parentValue: e2, value: d };
            b.context = d;
            X(a, b, f);
            a = E;
    ...
    function X(a, b, c2) {
      ...
      if ("object" === typeof c2 && null !== c2) {
        switch (c2.$$typeof) {
          case Ga:
            Gb(a, b, c2.type, c2.props, c2.ref);
            return;
          case Ha:
            throw Error(l2(257));
          case Ra:
        ...
        throw Error(l2(31, "[object Object]" === a ? "object with keys {" + Object.keys(c2).join(", ") + "}" : a));
      }
      "string" === typeof c2 ? (d = b.blockedSegment, d.lastPushedText = Fa(b.blockedSegment.chunks, c2, a.responseState, d.lastPushedText)) : "number" === typeof c2 && (d = b.blockedSegment, d.lastPushedText = Fa(b.blockedSegment.chunks, "" + c2, a.responseState, d.lastPushedText));
    }
    __name(X, "X");
    function Ib(a, b, c2) {
    ...
    function Lb(a, b, c2) {
      ...
      null === d ? (b.allPendingTasks--, 2 !== b.status && (b.status = 2, null !== b.destination && b.destination.push(null))) : (d.pendingTasks--, d.forceClientRender || (d.forceClientRender = true, a = void 0 === c2 ? Error(l2(432)) : c2, d.errorDigest = b.onError(a), d.parentFlushed && b.clientRenderedBoundaries.push(d)), d.fallbackAbortableTasks.forEach(function(a2) {
        return Lb(a2, b, c2);
    ...
    function Kb(a, b, c2) {
      ...
      } else b.pendingTasks--, b.forceClientRender || (0 === b.pendingTasks ? (c2.parentFlushed && 1 === c2.status && Y(b, c2), b.parentFlushed && a.completedBoundaries.push(b), b.fallbackAbortableTasks.forEach(Jb, a), b.fallbackAbortableTasks.clear()) : c2.parentFlushed && 1 === c2.status && (Y(b, c2), 1 === b.completedSegments.length && b.parentFlushed && a.partialBoundaries.push(b)));
      a.allPendingTasks--;
            ...
            if (0 === k.status) {
              ...
              try {
                ...
                if (rb(), "object" === typeof z && null !== z && "function" === typeof z.then) {
                  ...
                  g.abortSet.delete(g);
                  k.status = 4;
                  var n2 = g.blockedBoundary, q = z, C = V2(h, q);
    ...
    function Nb(a, b, c2) {
      var d = c2.boundary;
      if (null === d) return Z(a, b, c2);
      d.parentFlushed = true;
      if (d.forceClientRender) return a.responseState.generateStaticMarkup || (d = d.errorDigest, b.push("<!--$!-->"), b.push("<template"), d && (b.push(' data-dgst="'), d = v(d), b.push(d), b.push('"')), b.push("></template>")), Z(a, b, c2), a = a.responseState.generateStaticMarkup ? true : b.push("<!--/$-->"), a;
      if (0 < d.pendingTasks) {
      ...
      if (d.byteSize > a.progressiveChunkSize) return d.rootSegmentID = a.nextSegmentId++, a.completedBoundaries.push(d), za(b, a.responseState, d.id), Z(a, b, c2), b.push("<!--/$-->");
    ...
    __name(Nb, "Nb");
    function Ob(a, b, c2) {
      Aa(b, a.responseState, c2.formatContext, c2.id);
      Nb(a, b, c2);
      return Ba(b, c2.formatContext);
    }
    __name(Ob, "Ob");
    function Pb(a, b, c2) {
      for (var d = c2.completedSegments, f = 0; f < d.length; f++) Qb(a, b, c2, d[f]);
      d.length = 0;
      a = a.responseState;
      d = c2.id;
      c2 = c2.rootSegmentID;
    ...
    function Mb(a, b) {
      try {
        ...
        for (e2 = 0; e2 < f.length; e2++) {
          var g = f[e2];
          d = b;
          var h = a.responseState, k = g.id, m = g.errorDigest, n2 = g.errorMessage, q = g.errorComponentStack;
        ...
        for (e2 = 0; e2 < ba.length; e2++) if (!Pb(a, b, ba[e2])) {
          a.destination = null;
          e2++;
          ba.splice(0, e2);
          return;
        ...
        for (e2 = 0; e2 < ea.length; e2++) if (!Pb(a, b, ea[e2])) {
          a.destination = null;
          e2++;
          ea.splice(0, e2);
          return;
    ...
    function Tb(a, b, c2, d) {
      var f = false, e2 = null, g = "", h = { push: /* @__PURE__ */ __name(function(a2) {
        null !== a2 && (g += a2);
        return true;
      ...
      a = Ab(a, Ea(c2, b ? b.identifierPrefix : void 0), { insertionMode: 1, selectedValue: null }, Infinity, Sb, void 0, function() {
        k = true;
      }, void 0, void 0);
      Cb(a);
      Rb(a, d);
...
var require_react_dom_server_browser_production_min = __commonJS({
  "../node_modules/react-dom/cjs/react-dom-server.browser.production.min.js"(exports) {
    ...
    var n2 = 0;
    function p(a, b) {
      if (0 !== b.length) if (512 < b.length) 0 < n2 && (a.enqueue(new Uint8Array(l2.buffer, 0, n2)), l2 = new Uint8Array(512), n2 = 0), a.enqueue(b);
      else {
        var c2 = l2.length - n2;
        c2 < b.length && (0 === c2 ? a.enqueue(l2) : (l2.set(b.subarray(0, c2), n2), a.enqueue(l2), b = b.subarray(c2)), l2 = new Uint8Array(512), n2 = 0);
        l2.set(b, n2);
        n2 += b.length;
      }
    }
    ...
    __name(t2, "t");
    function ba(a) {
      l2 && 0 < n2 && (a.enqueue(new Uint8Array(l2.buffer, 0, n2)), l2 = null, n2 = 0);
    }
    __name(ba, "ba");
    ...
    __name(ya, "ya");
    function za(a, b, c2, d, f) {
      a = void 0 === a ? "" : a;
      b = void 0 === b ? sa : w('<script nonce="' + C(b) + '">');
      var e2 = [];
      void 0 !== c2 && e2.push(b, u(("" + c2).replace(xa, ya)), ta);
      if (void 0 !== d) for (c2 = 0; c2 < d.length; c2++) e2.push(ua, u(C(d[c2])), wa);
    ...
    function Ia(a, b, c2) {
      ...
      for (var d in c2) if (x.call(c2, d)) {
        ...
        if (null != f && "boolean" !== typeof f && "" !== f) {
          ...
          b ? (b = false, a.push(Fa, e2, Ga, f)) : a.push(Ha, e2, Ga, f);
        }
      }
      b || a.push(E);
    }
    ...
    function J(a, b, c2, d) {
      ...
      if (!(2 < c2.length) || "o" !== c2[0] && "O" !== c2[0] || "n" !== c2[1] && "N" !== c2[1]) {
        if (b = z.hasOwnProperty(c2) ? z[c2] : null, null !== b) {
          ...
          c2 = u(b.attributeName);
          switch (b.type) {
            case 3:
              d && a.push(H, c2, Ja);
              break;
            case 4:
              true === d ? a.push(H, c2, Ja) : false !== d && a.push(H, c2, I2, u(C(d)), E);
              break;
            case 5:
              isNaN(d) || a.push(H, c2, I2, u(C(d)), E);
              break;
            case 6:
              !isNaN(d) && 1 <= d && a.push(H, c2, I2, u(C(d)), E);
              break;
            default:
              b.sanitizeURL && (d = "" + d), a.push(H, c2, I2, u(C(d)), E);
          }
        } else if (ia(c2)) {
          switch (typeof d) {
            case "function":
    ...
    function Na(a, b, c2, d) {
      ...
      a.push(K);
      L(a, f, c2);
      return "string" === typeof c2 ? (a.push(u(C(c2))), null) : c2;
    }
    __name(Na, "Na");
    var Oa = w("\n");
    ...
    function Sa(a, b, c2, d, f) {
      switch (b) {
        ...
        case "option":
          ...
          if (null != g) if (c2 = null !== m ? "" + m : La(h), ra(g)) for (d = 0; d < g.length; d++) {
            if ("" + g[d] === c2) {
              a.push(Ma);
              break;
            }
        ...
        case "textarea":
          a.push(M("textarea"));
          r2 = g = e2 = null;
          for (h in c2) if (x.call(c2, h) && (m = c2[h], null != m)) switch (h) {
            case "children":
              r2 = m;
              break;
            case "value":
        ...
        case "input":
          a.push(M("input"));
          m = r2 = h = e2 = null;
          for (g in c2) if (x.call(c2, g) && (q = c2[g], null != q)) switch (g) {
            case "children":
            case "dangerouslySetInnerHTML":
        ...
        case "title":
          a.push(M("title"));
          e2 = null;
          for (v in c2) if (x.call(c2, v) && (g = c2[v], null != g)) switch (v) {
            case "children":
              e2 = g;
              break;
            case "dangerouslySetInnerHTML":
        ...
        case "pre":
          a.push(M(b));
          g = e2 = null;
          for (m in c2) if (x.call(c2, m) && (h = c2[m], null != h)) switch (m) {
            case "children":
              e2 = h;
              break;
            case "dangerouslySetInnerHTML":
          ...
          if (null != g) {
            ...
            c2 = g.__html;
            null !== c2 && void 0 !== c2 && ("string" === typeof c2 && 0 < c2.length && "\n" === c2[0] ? a.push(Oa, u(c2)) : a.push(u("" + c2)));
          }
          "string" === typeof e2 && "\n" === e2[0] && a.push(Oa);
          return e2;
        case "area":
        ...
        case "missing-glyph":
          return Na(a, c2, b, d);
        case "html":
          return 0 === f.insertionMode && a.push(Ra), Na(a, c2, b, d);
        default:
          if (-1 === b.indexOf("-") && "string" !== typeof c2.is) return Na(a, c2, b, d);
          a.push(M(b));
          g = e2 = null;
          for (q in c2) if (x.call(c2, q) && (h = c2[q], null != h)) switch (q) {
            case "children":
              e2 = h;
              break;
            case "dangerouslySetInnerHTML":
            ...
            case "suppressHydrationWarning":
              break;
            default:
              ia(q) && "function" !== typeof h && "symbol" !== typeof h && a.push(H, u(q), I2, u(C(h)), E);
          }
          a.push(K);
          L(a, g, e2);
          return e2;
    ...
    function Bb(a, b, c2, d) {
      switch (c2.insertionMode) {
        case 0:
        case 1:
          return p(a, gb), p(a, b.segmentPrefix), p(a, u(d.toString(16))), t2(a, hb);
        case 2:
          return p(a, jb), p(a, b.segmentPrefix), p(a, u(d.toString(16))), t2(a, kb);
        case 3:
          return p(a, mb), p(a, b.segmentPrefix), p(a, u(d.toString(16))), t2(a, nb);
        case 4:
          return p(a, pb), p(a, b.segmentPrefix), p(a, u(d.toString(16))), t2(a, qb);
        case 5:
          return p(a, sb), p(a, b.segmentPrefix), p(a, u(d.toString(16))), t2(a, tb);
        case 6:
          return p(a, vb), p(a, b.segmentPrefix), p(a, u(d.toString(16))), t2(a, wb);
        case 7:
          return p(
            a,
            yb
          ), p(a, b.segmentPrefix), p(a, u(d.toString(16))), t2(a, zb);
        default:
          throw Error(k(397));
      }
    }
    ...
    function pc(a, b) {
      ...
      a.depth === c2.depth ? P(a, c2) : pc(a, c2);
      b.context._currentValue = b.value;
    }
    __name(pc, "pc");
    function Q(a) {
    ...
    function rc(a, b, c2, d) {
      ...
      g = b.getDerivedStateFromProps;
      "function" === typeof g && (g = g(c2, f), f = null === g || void 0 === g ? f : N({}, f, g), a.state = f);
    ...
    function tc(a, b, c2) {
      ...
      if (30 < e2) {
        ...
        d >>= g;
        f -= g;
        return { id: 1 << 32 - uc(b) + f | c2 << f | d, overflow: e2 + a };
      }
      return { id: 1 << e2 | c2 << f | d, overflow: a };
    }
    __name(tc, "tc");
    ...
    function Ic(a, b, c2) {
      ...
      a = a === Hc ? "function" === typeof b ? b() : b : void 0 !== c2 ? c2(b) : b;
      S.memoizedState = a;
    ...
    function Jc(a, b, c2) {
      ...
      if (a === R) if (Cc = true, a = { action: c2, next: null }, null === V2 && (V2 = /* @__PURE__ */ new Map()), c2 = V2.get(b), void 0 === c2) V2.set(b, a);
      else {
        for (b = c2; null !== b.next; ) b = b.next;
        b.next = a;
      }
    ...
    __name(X, "X");
    function Rc(a, b, c2, d, f, e2, g, h, m) {
      ...
      c2.parentFlushed = true;
      a = Tc(b, a, null, c2, r2, kc, null, sc);
      q.push(a);
      return b;
    }
    __name(Rc, "Rc");
    function Tc(a, b, c2, d, f, e2, g, h) {
      a.allPendingTasks++;
      null === c2 ? a.pendingRootTasks++ : c2.pendingTasks++;
    ...
    __name(Vc, "Vc");
    function Wc(a, b, c2, d, f) {
      R = {};
      Ac = b;
      U = 0;
      for (a = c2(d, f); Cc; ) Cc = false, U = 0, Dc += 1, S = null, a = c2(d, f);
      Gc();
      return a;
    }
    __name(Wc, "Wc");
    function Xc(a, b, c2, d) {
      var f = c2.render(), e2 = d.childContextTypes;
      if (null !== e2 && void 0 !== e2) {
        var g = b.legacyContext;
        if ("function" !== typeof c2.getChildContext) d = g;
    ...
    __name(Yc, "Yc");
    function Zc(a, b, c2, d, f) {
      if ("function" === typeof c2) if (c2.prototype && c2.prototype.isReactComponent) {
        f = lc(c2, b.legacyContext);
        var e2 = c2.contextType;
        ...
        f = Wc(a, b, c2, d, e2);
        var g = 0 !== U;
        if ("object" === typeof f && null !== f && "function" === typeof f.render && void 0 === f.$$typeof) rc(f, c2, d, e2), Xc(a, b, f, c2);
        else if (g) {
          d = b.treeContext;
        ...
        f = b.blockedSegment;
        e2 = Sa(f.chunks, c2, d, a.responseState, f.formatContext);
        f.lastPushedText = false;
        g = f.formatContext;
        f.formatContext = Ba(g, c2, d);
        $c(a, b, e2);
        f.formatContext = g;
        switch (c2) {
          case "area":
        ...
        switch (c2) {
          ...
          case ac:
            a: {
              ...
              b = Tc(a, e2, c2, m, g, b.legacyContext, b.context, b.treeContext);
              a.pingedTasks.push(b);
            }
            return;
        }
    ...
    function Z(a, b, c2) {
      ...
      if ("object" === typeof c2 && null !== c2) {
        switch (c2.$$typeof) {
          case Tb:
            Zc(a, b, c2.type, c2.props, c2.ref);
            return;
          case Ub:
            throw Error(k(257));
          case dc:
        ...
        a = Object.prototype.toString.call(c2);
        throw Error(k(31, "[object Object]" === a ? "object with keys {" + Object.keys(c2).join(", ") + "}" : a));
      }
      "string" === typeof c2 ? (d = b.blockedSegment, d.lastPushedText = Da(b.blockedSegment.chunks, c2, a.responseState, d.lastPushedText)) : "number" === typeof c2 && (d = b.blockedSegment, d.lastPushedText = Da(b.blockedSegment.chunks, "" + c2, a.responseState, d.lastPushedText));
    }
    __name(Z, "Z");
    function bd(a, b, c2) {
      for (var d = c2.length, f = 0; f < d; f++) {
    ...
    function ed(a, b, c2) {
      var d = a.blockedBoundary;
      a.blockedSegment.status = 3;
      null === d ? (b.allPendingTasks--, 2 !== b.status && (b.status = 2, null !== b.destination && b.destination.close())) : (d.pendingTasks--, d.forceClientRender || (d.forceClientRender = true, a = void 0 === c2 ? Error(k(432)) : c2, d.errorDigest = b.onError(a), d.parentFlushed && b.clientRenderedBoundaries.push(d)), d.fallbackAbortableTasks.forEach(function(a2) {
        return ed(a2, b, c2);
      }), d.fallbackAbortableTasks.clear(), b.allPendingTasks--, 0 === b.allPendingTasks && (d = b.onAllReady, d()));
    }
    __name(ed, "ed");
    ...
    function dd(a, b, c2) {
      ...
      } else b.pendingTasks--, b.forceClientRender || (0 === b.pendingTasks ? (c2.parentFlushed && 1 === c2.status && ad(b, c2), b.parentFlushed && a.completedBoundaries.push(b), b.fallbackAbortableTasks.forEach(cd, a), b.fallbackAbortableTasks.clear()) : c2.parentFlushed && 1 === c2.status && (ad(b, c2), 1 === b.completedSegments.length && b.parentFlushed && a.partialBoundaries.push(b)));
      a.allPendingTasks--;
      0 === a.allPendingTasks && (a = a.onAllReady, a());
    }
    __name(dd, "dd");
    ...
    function gd(a, b, c2) {
      ...
      switch (c2.status) {
        ...
        case 1:
          ...
          c2 = c2.children;
          for (var g = 0; g < c2.length; g++) {
            for (f = c2[g]; e2 < f.index; e2++) p(b, d[e2]);
            f = hd(a, b, f);
          }
    ...
    function hd(a, b, c2) {
      var d = c2.boundary;
      if (null === d) return gd(a, b, c2);
      d.parentFlushed = true;
      if (d.forceClientRender) d = d.errorDigest, t2(b, $a), p(b, bb), d && (p(b, db), p(b, u(C(d))), p(b, cb)), t2(b, eb), gd(a, b, c2);
        ...
        gd(a, b, c2);
      } else if (d.byteSize > a.progressiveChunkSize) d.rootSegmentID = a.nextSegmentId++, a.completedBoundaries.push(d), fb(b, a.responseState, d.id), gd(a, b, c2);
      else {
        t2(b, Xa);
        c2 = d.completedSegments;
    ...
    __name(hd, "hd");
    function id(a, b, c2) {
      Bb(b, a.responseState, c2.formatContext, c2.id);
      hd(a, b, c2);
      return Cb(b, c2.formatContext);
    }
    __name(id, "id");
    function jd(a, b, c2) {
      for (var d = c2.completedSegments, f = 0; f < d.length; f++) kd(a, b, c2, d[f]);
      d.length = 0;
      a = a.responseState;
      d = c2.id;
      c2 = c2.rootSegmentID;
    ...
    function fd(a, b) {
      ...
      try {
        ...
        for (e2 = 0; e2 < A.length; e2++) if (!jd(a, b, A[e2])) {
          a.destination = null;
          e2++;
          A.splice(0, e2);
          return;
        ...
        for (e2 = 0; e2 < na.length; e2++) if (!jd(a, b, na[e2])) {
          a.destination = null;
          e2++;
          na.splice(0, e2);
          return;
    ...
    exports.renderToReadableStream = function(a, b) {
      return new Promise(function(c2, d) {
        var f, e2, g = new Promise(function(a2, b2) {
          e2 = a2;
          f = b2;
        }), h = Rc(a, za(b ? b.identifierPrefix : void 0, b ? b.nonce : void 0, b ? b.bootstrapScriptContent : void 0, b ? b.bootstrapScripts : void 0, b ? b.bootstrapModules : void 0), Aa(b ? b.namespaceURI : void 0), b ? b.progressiveChunkSize : void 0, b ? b.onError : void 0, e2, function() {
...
var init_parseley = __esm({
  "../node_modules/parseley/lib/parseley.mjs"() {
    ...
    identifier_ = token((t2) => t2.name === "ident" ? unescape2(t2.text) : void 0);
    hashId_ = token((t2) => t2.name === "hash" ? unescape2(t2.text.slice(1)) : void 0);
    string_ = token((t2) => t2.name.startsWith("str") ? unescape2(t2.text.slice(1, -1)) : void 0);
    namespace_ = left(option(identifier_, ""), literal("|"));
    qualifiedName_ = otherwise(ab(namespace_, identifier_, (ns, name2) => ({ name: name2, namespace: ns })), map(identifier_, (name2) => ({ name: name2, namespace: null })));
...
function getEscaper(regex, map2) {
  return /* @__PURE__ */ __name(function escape4(data) {
    let match2;
    let lastIdx = 0;
    let result = "";
...
var require_inputscanner = __commonJS({
  "../node_modules/js-beautify/js/src/core/inputscanner.js"(exports, module) {
    ...
    InputScanner.prototype.read = function(starting_pattern, until_pattern, until_after) {
      ...
      var match2;
      if (starting_pattern) {
        match2 = this.match(starting_pattern);
        if (match2) {
          val += match2[0];
        }
      }
      if (until_pattern && (match2 || !starting_pattern)) {
    ...
    InputScanner.prototype.get_regexp = function(pattern, match_from) {
      ...
      if (typeof pattern === "string" && pattern !== "") {
        result = new RegExp(pattern, flags2);
      } else if (pattern) {
        result = new RegExp(pattern.source, flags2);
      }
      return result;
    };
  ...
  "../node_modules/js-beautify/js/src/javascript/tokenizer.js"(exports, module) {
    ...
    Tokenizer2.prototype._read_xml = function(c2, previous_token) {
      if (this._options.e4x && c2 === "<" && this._allow_regexp_or_xml(previous_token)) {
        var xmlStr = "";
        var match2 = this.__patterns.xml.read_match();
        if (match2) {
          var rootTag = match2[2].replace(/^{\s+/, "{").replace(/\s+}$/, "}");
          var isCurlyRoot = rootTag.indexOf("{") === 0;
          var depth = 0;
          while (match2) {
            var isEndTag = !!match2[1];
            var tagName = match2[2];
            var isSingletonTag = !!match2[match2.length - 1] || tagName.slice(0, 8) === "![CDATA[";
            ...
            match2 = this.__patterns.xml.read_match();
          }
          if (!match2) {
...
var require_js = __commonJS({
  "../node_modules/js-beautify/js/index.js"(exports, module) {
    ...
    function get_beautify(js_beautify, css_beautify, html_beautify) {
      var beautify = /* @__PURE__ */ __name(function(src, config) {
...
var ReactDomServer, import_js_beautify, __defProp2, __getOwnPropSymbols, __hasOwnProp2, __propIsEnum, __defNormalProp, __spreadValues, __async, defaults, pretty, plainTextSelectors, decoder, readStream, renderAsync;
var init_browser = __esm({
  "../node_modules/@react-email/render/dist/browser/index.mjs"() {
    ...
    renderAsync = /* @__PURE__ */ __name((component, options) => __async(void 0, null, function* () {
...
var __defProp3, __defProps, __getOwnPropDescs, __getOwnPropSymbols2, __hasOwnProp3, __propIsEnum2, __defNormalProp2, __spreadValues2, __spreadProps, __async2, version, ApiKeys, Audiences, Batch, Contacts, Domains, Emails, defaultBaseUrl, defaultUserAgent, baseUrl, userAgent, Resend;
var init_dist = __esm({
  "../node_modules/resend/dist/index.mjs"() {
    init_functionsRoutes_0_10284754669331897();
    init_browser();
    ...
    __defNormalProp2 = /* @__PURE__ */ __name((obj, key, value) => key in obj ? __defProp3(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value, "__defNormalProp");
    __spreadValues2 = /* @__PURE__ */ __name((a, b) => {
      for (var prop in b || (b = {}))
    ...
    __async2 = /* @__PURE__ */ __name((__this, __arguments, generator) => {
      return new Promise((resolve, reject) => {
        var fulfilled = /* @__PURE__ */ __name((value) => {
          try {
            step(generator.next(value));
...
async function onRequest3(context) {
  const corsHeaders = { "Access-Control-Allow-Origin": "*", "Access-Control-Allow-Methods": "GET, POST, OPTIONS", "Access-Control-Allow-Headers": "Content-Type, Stripe-Signature" };
  if (context.request.method === "OPTIONS") {
    return new Response(null, { headers: corsHeaders });
  }
  try {
    ...
    const customerEmail = body.data?.object?.customer_details?.email || body.data?.object?.customer_email || "cliente@saare.es";
    const companyName = body.data?.object?.custom_fields?.[0]?.text?.value || "Empresa Cliente";
    const evalToken = btoa(JSON.stringify({ company: companyName, type: "ENTERPRISE_LICENSE", exp: new Date(Date.now() + 365 * 24 * 60 * 60 * 1e3).toISOString() }));
    return new Response(JSON.stringify({ success: true, message: "Licencia generada correctamente", customerEmail, evalToken }), { status: 200, headers: { ...corsHeaders, "Content-Type": "application/json" } });
  } catch (err) {
    ...
    try {
      ...
      if (decodedPayload.role !== "engineer" && decodedPayload.role !== "admin") {
        return new Response(
          JSON.stringify({
            error: "FORBIDDEN",
            message: "Acceso denegado: El perfil " + decodedPayload.role + " no tiene permisos de ingenier\xEDa."
          }),
          {
            status: 403,
            headers: {
      ...
      return new Response(
        JSON.stringify({ error: "INVALID_TOKEN", message: "Firma o formato del token no v\xE1lido." }),
        {
          status: 400,
          headers: {
            "Content-Type": "application/json",
...
// ../.wrangler/tmp/pages-ZmkYp2/functionsRoutes-0.10284754669331897.mjs
var routes;
var init_functionsRoutes_0_10284754669331897 = __esm({
  "../.wrangler/tmp/pages-ZmkYp2/functionsRoutes-0.10284754669331897.mjs"() {
    init_completions();
    init_config();
    init_leads();
