...
export class AuthMiddleware {
  ...
  // Simulación de validación de firma y decodificación de Claims JWT
  verifyAndDecodeToken(token) {
    ...
    if (parts.length !== 3) {
      throw new Error("[AUTH_ERROR] Firma JWT no válida");
    }
    ...
    let assignedRole = "Business"; // Rol por defecto (mínimo privilegio)
...
console.log("=== authMiddleware.js generado exitosamente ===");
