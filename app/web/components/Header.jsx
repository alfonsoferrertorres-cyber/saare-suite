  ...
  return (
    <header className="sticky top-0 z-50 bg-[#050811]/85 backdrop-blur-md border-b border-slate-800 px-6 lg:px-8 py-3.5 flex justify-between items-center transition-all">
      ...
      <a href="/" className="flex items-center gap-3 group">
        <img 
          src="/logo_saare.ico" 
          alt="SAARE Platform Logo" 
          className="h-8 w-8 rounded border border-slate-700 bg-black/60 p-1 group-hover:border-[#00f0ff] transition-colors" 
        />
        <span className="font-serif font-extrabold text-white tracking-wider text-sm lg:text-base">
          SAARE PLATFORM
        </span>
      </a>
