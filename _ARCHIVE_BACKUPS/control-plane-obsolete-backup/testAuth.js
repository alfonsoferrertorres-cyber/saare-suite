...
// 1. Probar usuario del equipo de Ingenier�a
console.log("\n[FASE 1] Autenticando usuario OIDC de Ingenier�a...");
...
// 2. Probar usuario de Auditor�a/CISO (M�nimo Privilegio)
console.log("\n[FASE 2] Autenticando usuario OIDC de Auditor�a...");
