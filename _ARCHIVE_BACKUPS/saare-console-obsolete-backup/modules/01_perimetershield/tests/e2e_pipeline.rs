...
#[test]
#[ignore = "Pausado temporalmente hasta sincronizar firma canónica con saare-core"]
fn test_end_to_end_compliance_pipeline() {
    // 1. Emisión de Licencia Corporativa
